"""
Django settings for CaBiPoller project.
...
SECRET_KEY = '+@y8!7)+*l(!+(=o8pr+ty)-=1c_!e(c6%$qvhkd*cq%tizd+g'
...
WSGI_APPLICATION = 'CaBiPoller.wsgi.application'
